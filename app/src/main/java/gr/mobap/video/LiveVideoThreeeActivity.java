...
public class LiveVideoThreeeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (androidNetworkUtility.isConnected(this)) {
            ...
            emVideoView.setVideoURI(Uri.parse("http://streamer-cache.grnet.gr/parliament/hls/webtv3.m3u8"));
            emVideoView.start();
        } else {
            // display error
            ...
            new Handler().postDelayed(() -> {
                Intent i = new Intent(LiveVideoThreeeActivity.this, MainActivity.class);
                startActivity(i);
                // close this activity
                finish();
