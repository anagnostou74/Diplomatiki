...
public class EpiTodayFragment extends Fragment {
    private Tracker mTracker;
    private WebView webView;
    private Bundle webViewBundle;
    private ProgressDialog progress;
    String url = "https://www.hellenicparliament.gr/Koinovouleftikes-Epitropes/Evdomadiaio-Deltio";
    private static final String TAG = "EpiTodayFragment";

    public EpiTodayFragment() {
    ...
    private void web() {
        try {
            Document doc = Jsoup.connect(url)
                    ...
                    .get();
            doc.select("#ctl00_ContentPlaceHolder1_ccsc_lnkBackToList")
                    .remove();
