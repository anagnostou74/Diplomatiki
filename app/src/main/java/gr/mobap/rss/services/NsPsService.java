...
public class NsPsService extends IntentService {

	public static final String RSS_LINK = "https://www.hellenicparliament.gr/rssfeed/RssLegislativeWork.aspx";
	...
	protected void onHandleIntent(Intent intent) {
		Log.d(Constants.TAG, "NsPsService started");
