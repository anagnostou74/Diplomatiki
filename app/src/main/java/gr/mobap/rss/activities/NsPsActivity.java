...
import gr.mobap.R;
import gr.mobap.rss.fragments.NsPsFragment;

public class NsPsActivity extends Base {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (androidNetworkUtility.isConnected(this)) {
            ...
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent i = new Intent(NsPsActivity.this, MainActivity.class);
                    startActivity(i);
                    // close this activity
                    finish();
                }
    ...
    private void setupViewPager(ViewPager fragment_container) {
        ...
        adapter.addFrag(new NsPsFragment(), getString(R.string.psifisthenta));
        fragment_container.setAdapter(adapter);
    }

    public com.google.firebase.appindexing.Action getAction() {
        return Actions.newView("NsPs page", "http://www.mobap.gr/nspsactivity");
    }
