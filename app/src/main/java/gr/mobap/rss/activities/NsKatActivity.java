...
import gr.mobap.R;
import gr.mobap.rss.fragments.NsKatFragment;

public class NsKatActivity extends Base {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (androidNetworkUtility.isConnected(this)) {
            ...
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent i = new Intent(NsKatActivity.this, MainActivity.class);
                    startActivity(i);
                    // close this activity
                    finish();
                }
    ...
    private void setupViewPager(ViewPager fragment_container) {
        ...
        adapter.addFrag(new NsKatFragment(), getString(R.string.katatethenta));
        fragment_container.setAdapter(adapter);
    }

    public Action getAction() {
        return Actions.newView("NsKat page", "http://www.mobap.gr/nskatactivity");
    }
