...
public class SinEpActivity extends Base {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (androidNetworkUtility.isConnected(this)) {
            ...
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent i = new Intent(SinEpActivity.this, MainActivity.class);
                    startActivity(i);
                    // close this activity
                    finish();
                }
    ...
    private void setupViewPager(ViewPager fragment_container) {
        ...
        adapter.addFrag(new SinEpFragment(), getString(R.string.sinedriaseis_epitropon));
        fragment_container.setAdapter(adapter);
    }

    public Action getAction() {
        return Actions.newView("SinEp page", "http://www.mobap.gr/sinepactivity");
    }
