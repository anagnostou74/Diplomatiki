...
public class EktheseisEpActivity extends Base {
    ...
    private void setupViewPager(ViewPager fragment_container) {
        ...
        adapter.addFrag(new EktheseisEpFragment(), getString(R.string.ektheseis));
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("EktheseisEp Page") // TODO: Define a title for the content shown.
                // TODO: Make sure this auto-generated URL is correct.
                .setUrl(Uri.parse("http://www.mobap.gr/ektheseisepactivity"))
                .build();
