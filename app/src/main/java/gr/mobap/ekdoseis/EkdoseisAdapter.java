...
public class EkdoseisAdapter extends FirebaseRecyclerAdapter<EkdoseisData, EkdoseisViewHolder> {
     ...
     * @param options
     */
    public EkdoseisAdapter(@NonNull FirebaseRecyclerOptions<EkdoseisData> options, Context context) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull EkdoseisViewHolder ekdoseisViewHolder, int position, @NonNull EkdoseisData ekdoseisData) {
        ...
        ekdoseisViewHolder.itemView.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(context, DownloadAndOpen.class);
            intent.putExtra(DownloadAndOpen.EXTRA_POST_KEY, postKey);
